...
namespace Cuyahoga.Modules.Shop
{
	...
	///		Summary description.
	/// </summary>
	public class ShopNewProduct : BaseModuleControl
	{
		...
		private void btnPublish_Click(object sender, System.EventArgs e)
		{
			if(this.Page.IsValid)
			{
				...
				ShopProduct tShopProduct	= new ShopProduct();
				...
				if(postedFile.ContentLength > 0)
				{
					try
					{
						...
						fFile = this.SaveAttachment(tShopProduct,this.txtAttachment);
				...
				tShopShop.NumProducts++;
				tShopShop.NumComments++;
